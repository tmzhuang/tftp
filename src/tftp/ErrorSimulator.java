		...
		public void run()
		{
			try
			{
				...
				try
				{
					...
					//If received packet is from the server
					if(fromServer)
					{
		...
		public void run()
		{
			try
			{
				...
				try
				{
					...
					while (true) 
					{
						// Creates a DatagramPacket to receive data packet
						DatagramPacket receivedPacket = TFTP.formPacket();
					...
					//If received packet is from client
					if(fromClient)
					{
					...
					//If packet received is from Server
					else {
